...
class _SpecialOffersState extends State<SpecialOffers> {
  ...
  getBusiness(String id) async {
    String bName = "";
    var sub = await FirebaseFirestore.instance.collection('businesses').doc(id).get().then((value){
      bName = value.get('name');
    });
    return bName;
  }
              ...
              child: offers!=null?ListView.builder(
                  ...
                  itemBuilder: (context, i){
                    ...
                    return FutureBuilder(
                      future: getBusiness(offers[i]['businessId']),
                      builder: (context, snapshot){
                        if(snapshot.hasData){
                                        ...
                                        onTap: () async {
                                          ...
                                          Navigator.push(
                                            ...
                                            CupertinoPageRoute(builder: (context) => AddOffer(
                                              ...
                                              description: offers[i]['description'],
                                              businessNameAndID: snapshot.data+"+"+offers[i]['businessId'],
                                              image: image,
                                              id: offers[i].id,
                                            )),
                                          );
                          ...
                          return Center(child: LinearProgressIndicator(valueColor: new AlwaysStoppedAnimation<Color>(Theme.of(context).primaryColor)));
                        }
                      },
                    );
                  },
